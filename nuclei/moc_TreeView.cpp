...
static const char qt_meta_stringdata_TreeView[] = {
    "TreeView\0\0item\0showItem(QModelIndex)\0"
    "processClick(QModelIndex)\0"
};
...
void TreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->showItem((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 1: _t->processClick((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void TreeView::showItem(const QModelIndex & _t1)
{
