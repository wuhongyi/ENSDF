...
static const char qt_meta_stringdata_AbstractDataSource[] = {
    "AbstractDataSource\0"
};
...
const QMetaObjectExtraData AbstractDataSource::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject AbstractDataSource::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AbstractDataSource,
      qt_meta_data_AbstractDataSource, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AbstractDataSource::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AbstractDataSource))
